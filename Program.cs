...
//	Update History
//  ver.0.14.12 2020/01/23  [Chg] 代表色を2色抽出して時計とカレンダーにそれぞれ採用するようにした。彩度を調整した。
...
//  ver.0.13.11 2020/01/16  [Chg] 代表色抽出の精度を上げた。
//                          [Fix] 前のバージョンから設定が引き継がれない問題を対策した
//  ver.0.12.10 2020/01/13  [Chg] 曜日を大文字にした。曜日の大きさを変えた。行間に区切り線を追加した。
//  ver.0.11.9  2020/01/13  [Add] デジタル時計に曜日(Sun,Mon,...)を追加した。
//  ver.0.10.8  2020/01/11  [Add] デジタル時計表示を追加した。時計は7segment表示の各segmentをBezier曲線で描画する。
...
//  ver.0.07    2019/11/24  [Add] Crop表示モードを追加。画面の横幅・縦幅に合わせて拡大縮小するが、はみ出した部分はcropする。画像の縦長・横長に応じて適切に切り替える。
...
//  ver.0.06    2019/11/21  [Fix] SystemParametersInfoAのDLLimportの仕方がおかしかったのを修正（Windows10で動かない）
//  ver.0.05    2011/12/04  [Add] Resume slideshow when Enter key is pressed or timed out. Timeout is equal to screen saver's one.
...
//  ver.0.04    2010/04/13  [Fix] TopMost form property set to false
...
//  ver.0.03    2010/04/11  [Fix] Too much RAM is consumed until GC starts its work.
//  ver.0.02    2010/04/02  [Fix] ExposureBiasValue GCD Calculation
//                          [Fix] Default File Name Filter set to '.*'
//  ver.0.01    2010/04/02  First Version
